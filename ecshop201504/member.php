...
<?php
    ...
    //搜尋使用者文章資料
    $insertStr='';
    $sql2 = "SELECT * FROM article where userID = '$userid'";
    $result2 = mysql_query($sql2);
    while($row2 = @mysql_fetch_row($result2)){
        $temp = '';
        $temp .= '<article class="6u$ 12u$(xsmall) work-item">';
        $temp = $temp.'<a href="http://120.113.173.99/ecshop201504/article.php?article='.$row2[0].'" class="image fit thumb"><img src="article_photo/'.$row2[2].'" alt="" /></a>';
        $temp = $temp.'<p><img src="images/icon/heart.png">'.$row2[5].'&nbsp&nbsp;<img src="images/icon/comments.png">'.$row2[6].'</p></article>';
        $insertStr .= $temp;
    }
?>
	...
	<body id="top" onload="ShowArticle()">
        ...
        <!-- Profile -->
			<header id="mheader">
                ...
                <h1>
                    <strong><?php echo $userName ?></strong><br></h1>
		...
		<!-- Main -->
			<div id="main">
                <ul class="actions">
				    <li><a href="member_post.php" class="button">Post a new article</a></li>
				</ul>
                <br>
				<!-- One -->
					<!--<msection id="one">
				...
				<msection id="two">
				    <div id="ShowPictureArticle" class="row">
							<!--<article class="6u$ 12u$(xsmall) work-item">
								<a href="http://localhost:8080/BabyLoveCOM/" class="image fit thumb"><img src="images/test/t1.png" alt="" /></a>
								<p><img src="images/icon/heart.png">0&nbsp;<img src="images/icon/comments.png">0</p>
							</article>
							<article class="6u$ 12u$(xsmall) work-item">
								<a href="images/fulls/04.jpg" class="image fit thumb"><img src="images/Test/t2.jpg" alt="" /></a>
								<p><img src="images/icon/heart.png">0&nbsp;<img src="images/icon/comments.png">0</p>
							</article>
							<!--<article class="6u$ 12u$(xsmall) work-item">
